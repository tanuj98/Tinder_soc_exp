...
facebook_token = config.fb_access_token	# Refer to README.md for how to get token
facebook_id = config.fb_user_id	# Refer to README.md for how to get facebook ID
imagePath = 'tt'		# Name of folder images save to 
